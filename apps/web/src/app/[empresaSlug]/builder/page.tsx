    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-[var(--engine-primary)] to-[var(--engine-surface-solid)] p-6 rounded-2xl border border-[var(--engine-info)]/20 relative overflow-hidden">
        <div className="relative z-10">
          ...
          <p className="text-[var(--engine-text-muted)] text-sm">Trabaja en los proyectos asignados para esta empresa.</p>
        </div>
      ...
      <Link href={`${basePath}/artifacts`} className="block p-6 bg-white dark:bg-[var(--engine-surface-solid)] rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm">
