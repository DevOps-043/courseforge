              ...
              <div className="bg-white dark:bg-[#151A21] border border-gray-200 dark:border-[#6C757D]/10 rounded-2xl p-6 md:p-8 shadow-xl">
                  {mode === 'ai' ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input 
                                    ...
                                    onChange={e => {
                                        const val = e.target.value;
                                        setFormData(prev => ({...prev, targetAudience: val}));
                                    }}
                                />
                            </div>
                            <div className="space-y-2">
                                ...
                                <input 
                                    ...
                                    onChange={e => {
                                        const val = e.target.value;
                                        setFormData(prev => ({...prev, expectedResults: val}));
                                    }}
                                />
                            </div>
                        </div>
                      ...
                      <div className="flex flex-col items-center justify-center py-20 text-center">
                          <Upload size={48} className="text-gray-400 dark:text-[#6C757D] mb-4" />
                          <h3 className="text-gray-900 dark:text-white font-medium mb-2">Construcción en Proceso</h3>
                          <p className="text-gray-500 dark:text-[#94A3B8] max-w-md">La funcionalidad de importación estará disponible pronto. Por favor usa la generación con IA.</p>
                      </div>
                  )}
              </div>
          ...
          <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-[#0A2540]/5 dark:bg-[#0A2540]/50 border border-[#1F5AF6]/10 rounded-2xl p-6">
                  <div className="flex items-start gap-4">
                      ...
                      <div>
                          <h4 className="text-gray-900 dark:text-white font-medium text-sm mb-1">Calidad Garantizada</h4>
    ...
    return (
        <button 
            ...
            className={`
                ...
                ${active 
                    ? 'bg-white dark:bg-[#151A21] border-[#1F5AF6] shadow-lg shadow-[#1F5AF6]/10' 
                    : 'bg-white dark:bg-[#151A21]/50 border-gray-200 dark:border-[#6C757D]/10 hover:border-gray-300 dark:hover:border-[#6C757D]/30 hover:bg-gray-50 dark:hover:bg-[#151A21]'
                }
            `}
        >
