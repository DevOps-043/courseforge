...
import { generateArtifactAction } from '@/app/admin/artifacts/actions';
...
export default function ConstructorNewArtifactPage() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            if (result.success) {
                // Redirigir al pipeline del constructor en lugar del admin
                        ...
                        {mode === 'ai' ? (
                            ...
                            <ScormImportFlow
                                onComplete={(artifactId) => {
                                    ...
                                    router.push(`/builder/artifacts/${artifactId}`);
                                }}
                            />
                        )}
                    </div>
