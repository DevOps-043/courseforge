    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-[#94A3B8] ml-1">Usuario o Correo</label>
          <div className="relative group">
            ...
            <input 
              ...
              className="w-full bg-[#0A0D12] border border-[#6C757D]/20 rounded-xl py-3.5 pl-12 pr-4 text-white placeholder-gray-600 focus:outline-none focus:border-[#00D4B3]/50 focus:ring-1 focus:ring-[#00D4B3]/50 transition-all"
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            ...
            <input 
              ...
              className="w-full bg-[#0A0D12] border border-[#6C757D]/20 rounded-xl py-3.5 pl-12 pr-12 text-white placeholder-gray-600 focus:outline-none focus:border-[#00D4B3]/50 focus:ring-1 focus:ring-[#00D4B3]/50 transition-all"
              placeholder="••••••••"
              required
            />
            <button 
        ...
        <div className="flex items-center justify-between text-sm">
          <label className="flex items-center gap-2 cursor-pointer group">
            ...
            <span className="text-[#94A3B8] group-hover:text-gray-300 transition-colors">Recordarme</span>
          </label>
        ...
        <button 
          type="submit" 
          disabled={isLoading}
          className="w-full bg-[#0A2540] hover:bg-[#0d2f4d] disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-4 rounded-xl shadow-lg shadow-[#0A2540]/25 transition-all active:scale-[0.98] flex items-center justify-center gap-2 group border border-[#0A2540]"
        >
          {isLoading ? (
