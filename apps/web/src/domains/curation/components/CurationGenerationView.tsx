    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-20 animate-in fade-in duration-700">
      <div className="space-y-2">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
          <div className="p-2 rounded-lg bg-gray-50 dark:bg-[#0A2540] border border-gray-200 dark:border-[#00D4B3]/20 text-[#00D4B3]">
            <BookOpen size={24} />
          </div>
      ...
      <div className="relative overflow-hidden rounded-3xl border border-gray-200 dark:border-[#1E2329] bg-white dark:bg-[#0F1419] shadow-xl shadow-gray-200/70 dark:shadow-2xl dark:shadow-black/40 p-12 min-h-[500px] flex flex-col items-center justify-center group ring-1 ring-[#00D4B3]/10">
        ...
        <div className="absolute top-[-50%] left-[-20%] w-[800px] h-[800px] bg-[#00D4B3]/10 dark:bg-[#00D4B3]/5 rounded-full blur-[120px] animate-pulse-slow opacity-40 dark:opacity-30" />
        ...
        <div className="relative z-10 flex flex-col items-center max-w-xl w-full text-center space-y-12">
          <div className="relative w-32 h-32 flex items-center justify-center">
            ...
            <div className="relative w-16 h-16 bg-white dark:bg-[#151A21] border border-gray-200 dark:border-[#1E2329] rounded-2xl flex items-center justify-center shadow-[0_0_30px_rgba(0,212,179,0.08)] dark:shadow-[0_0_30px_rgba(0,212,179,0.05)] z-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              <p className="text-gray-600 dark:text-[#94A3B8] text-base leading-relaxed max-w-sm mx-auto font-light">
          ...
          <div className="w-full max-w-md space-y-3">
            <div className="flex justify-between items-end px-1">
              <span className="text-[10px] font-bold tracking-widest uppercase text-gray-500 dark:text-[#6C757D]">
                Estado del Agente
              </span>
            ...
            <div className="h-2 w-full bg-gray-100 dark:bg-[#151A21] rounded-full overflow-hidden border border-gray-200 dark:border-[#1E2329] p-[1px]">
              <motion.div
          ...
          <div className="flex flex-col gap-6 items-center w-full max-w-xs">
            <div className="flex items-center gap-2 px-4 py-2 bg-[#00D4B3]/10 dark:bg-[#151A21]/80 rounded-full border border-[#00D4B3]/20 backdrop-blur-sm">
            ...
            <button
              onClick={onRefresh}
              className="w-full py-3 px-4 rounded-xl border border-gray-200 dark:border-[#6C757D]/30 text-gray-600 dark:text-[#94A3B8] hover:text-[#0A2540] dark:hover:text-white hover:border-[#00D4B3] hover:bg-[#00D4B3]/5 transition-all duration-300 flex items-center justify-center gap-2 group"
            >
              <RefreshCw
                size={14}
