...
export function MaterialsStatsGrid({ lessons }: { lessons: MaterialLesson[] }) {
  return (
    <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
      ...
      <div className="p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg text-center border border-transparent dark:border-yellow-800">
        <p className="text-2xl font-bold text-yellow-700 dark:text-yellow-400">
          {lessons.filter((lesson) => lesson.state === "GENERATED").length}
        </p>
        <p className="text-xs text-gray-500 dark:text-gray-400">Por validar</p>
      </div>
      ...
      <div className="p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg text-center border border-transparent dark:border-orange-800">
        <p className="text-2xl font-bold text-orange-600 dark:text-orange-400">
          {lessons.filter((lesson) => lesson.state === "NEEDS_FIX" || lesson.state === "BLOCKED").length}
        </p>
