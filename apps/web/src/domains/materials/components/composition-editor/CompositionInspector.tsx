...
export function CompositionInspector({ animations, clip, colorGradingStatus, cropModeEnabled, onAnimationSelect, onDetachAudio, onPatch, onPreviewColorGrading, onPreviewCrop, onRemove, saving, selectedAnimationId, separatingAudio, separatingAudioProgress, track }: CompositionInspectorProps) {
