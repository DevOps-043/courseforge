...
export function CompositionInspector({ animations, clip, cropModeEnabled, onAnimationSelect, onDetachAudio, onPatch, onPreviewCrop, onRemove, saving, selectedAnimationId, separatingAudio, separatingAudioProgress, track }: CompositionInspectorProps) {
