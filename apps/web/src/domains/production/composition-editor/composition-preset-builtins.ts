...
const PRESENTER_CORNER = { heightRatio: 0.34, opacity: 1, rotation: 0, widthRatio: 0.24, xRatio: 0.73, yRatio: 0.62, zIndex: 10 };
const DECK_INSET = { heightRatio: 0.5, opacity: 1, rotation: 0, widthRatio: 0.46, xRatio: 0.51, yRatio: 0.25, zIndex: 10 };
const SUPPORTING_BROLL_INSET = { ...DECK_INSET, zIndex: 5 };
...
export const BUILT_IN_COMPOSITION_PRESETS: readonly BuiltInCompositionPreset[] = [
  builtIn({
    ...
    rules: [
      ...
      rule("broll", "BROLL", ["IMAGE", "VIDEO"], "PRESERVE", { ...FULL_CANVAS, zIndex: 5 }, [{ presetId: "FADE_IN", durationRatio: 0.08 }]),
    ],
  }),
  builtIn({
    ...
    rules: [
      ...
      rule("broll", "BROLL", ["IMAGE", "VIDEO"], "PRESERVE", SUPPORTING_BROLL_INSET, [{ presetId: "FADE_IN", durationRatio: 0.08 }]),
    ],
  }),
  builtIn({
    ...
    rules: [
      ...
      rule("broll", "BROLL", ["IMAGE", "VIDEO"], "PRESERVE", { ...FULL_CANVAS, zIndex: 5 }, [{ presetId: "ZOOM_IN", durationRatio: 0.15 }]),
