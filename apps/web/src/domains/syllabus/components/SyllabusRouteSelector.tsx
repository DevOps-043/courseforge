  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div
        ...
        className={`
          ...
          ${selectedRoute === 'B_NO_SOURCE'
            ? 'border-[var(--engine-accent)] bg-[var(--engine-accent)]/5 dark:bg-[var(--engine-accent)]/10 ring-1 ring-[var(--engine-accent)]'
            : 'border-gray-200 dark:border-white/10 bg-white dark:bg-[var(--engine-surface-hover)] hover:border-[var(--engine-accent)]/50 hover:bg-gray-50 dark:hover:bg-white/5'}
      ...
      >
        <div className="flex items-start justify-between mb-3">
          <div className={`
            ...
            ${selectedRoute === 'B_NO_SOURCE'
              ...
              : 'bg-gray-100 dark:bg-white/5 text-gray-500 dark:text-gray-400 group-hover:text-[var(--engine-accent)]'}
          `}>
            {/* Sparkles Icon */}
          ...
          {selectedRoute === 'B_NO_SOURCE' && (
            <div className="animate-in zoom-in duration-200">
               <svg className="w-6 h-6 text-[var(--engine-accent)]" fill="currentColor" viewBox="0 0 20 20">
        ...
        <h3 className="text-base font-bold text-[var(--engine-primary)] dark:text-white mb-2">IA Generativa</h3>
