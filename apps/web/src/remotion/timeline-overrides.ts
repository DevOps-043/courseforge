...
export type TimelineOverrideManifestInput = z.input<typeof timelineOverrideManifestSchema>;
export type TimelineOverrideManifestList = z.infer<typeof timelineOverrideManifestListSchema>;

export function parseTimelineOverrideManifests(
  raw: unknown,
): TimelineOverrideManifestList {
  return timelineOverrideManifestListSchema.parse(raw ?? []);
}

export function safeParseTimelineOverrideManifests(raw: unknown) {
  return timelineOverrideManifestListSchema.safeParse(raw ?? []);
}
